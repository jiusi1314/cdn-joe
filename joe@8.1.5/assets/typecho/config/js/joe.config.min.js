document.addEventListener("DOMContentLoaded", function() {
    ...
    if (e.forEach(function(o) {
        o.addEventListener("click", function() {
            ...
            sessionStorage.setItem("joe_config_current", c), "joe_notice" === c ? (t.style.display = "block", s.style.display = "none") : (t.style.display = "none", s.style.display = "block"), n.forEach(function(e) {
        ...
        "joe_notice" === o ? (t.style.display = "block", s.style.display = "none") : (s.style.display = "block", t.style.display = "none"), e.forEach(function(e) {
    ...
    }, c.open("get", "https://blog.zhuxu.xyz/api.php?type=collect&key=18e958d8c7fa5d435844f95c9f254fca", !0), c.send(null)
});